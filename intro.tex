...
Análogamente al \acf{PFC}, en este \acf{TFM} se ha extendido un framework de
procesamiento RDF distribuido con el fin de incorporar primitivas de evaluación
de calidad de los datos, permitiendo así establecer una comparativa en términos
de tiempo entre los desarrollos acontecidos en el \acf{PFC} y los del \acf{TFM}.
