...
En primer lugar, se define una función que calcula el valor de la métrica en sí
...
\ref{graphmetricRatio}.

Seguidamente, se generaliza el cálculo de la métrica para todo el grafo,
ilustrado en el listado \ref{graphmetricRatio}. Para
...
El conjunto total de arcos es combinado con el conjunto de arcos que cumplen las
propiedades. Agregando los resultados y contando el total de arcos y de
propiedades. 

Aplicando la función inicial para cada nodo del grafo, se obtiene la métrica
global para todos los nodos. 

En el paso final, se filtran los nodos del grafo para los nodos candidatos que
