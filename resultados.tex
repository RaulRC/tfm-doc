...
\begin{figure}[!h]
  \begin{center}
    \includegraphics[width=0.9\textwidth]{nifi-tweet.png} 
...
\begin{figure}[!h]
  \begin{center}
    \includegraphics[width=0.9\textwidth]{nifi-ms.png} 
...
\begin{figure}[!h]
  \begin{center}
    \includegraphics[width=0.9\textwidth]{nifi-s3.png} 
...
\begin{figure}[!h]
  \begin{center}
    \includegraphics[width=0.8\textwidth]{ontotweet.png} 
...
\begin{figure}[!h]
  \begin{center}
    \includegraphics[width=0.9\textwidth]{tweetes.png} 
...
\begin{figure}[!h]
  \begin{center}
    \includegraphics[width=0.9\textwidth]{assessment.png} 
...
en las tablas \ref{tab-jenadq} y \ref{tab-sparkdq}.
