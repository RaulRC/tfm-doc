...
El objetivo de esta PoC es ilustrar la capacidad de SparkDQ a través de un
...
La entrada y salida de datos de spark-sem-dq-assessment puede configurarse
  ...
  \item Directorios distribuidos en HDFS
...
\item Adquisición de tweets: NiFi ofrece un procesador específico que consulta
  ...
  serie de transformaciones (TODO) y finalmente se envían ms.semtweet para que
...
\item Enrutado de sem-tweets a almacenamiento distribuido: La segunda topología
  ...
  (directorio local, HDFS o S3).(REFERENCIA IMAGEN) 
\item Lectura desde almacenamiento y envío a sistema de visualización de
  ...
  Amazon 
  ElasticSearch y Kibana. (REFERENCIA IMAGEN)
\end{enumerate}
...
La última de las iteraciones ha dado como resultado los siguientes elementos: 
