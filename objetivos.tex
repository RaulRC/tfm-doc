...
\drop{E}{l} objetivo de este \acf{TFM} es \textbf{desarrollar un stack para el framework Apache Spark con el fin de dar soporte a primitivas de evaluación de calidad de datos semánticos en un entorno Big Data}. Dicho stack se apoyará
